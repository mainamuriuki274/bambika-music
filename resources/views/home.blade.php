...
<body>
<div style="background: #141414; position: fixed; bottom: 0; z-index: 1; max-width: 100% "
     class="container w-100 pt-1 pb-3">
    <div class="row">
        <div class="col-3">
            <div class="row h-100">
        ...
        <div class="col-6">
            ...
            <div class="middle d-flex align-items-center justify-content-center w-100">
                ...
                <button onclick="previous_song()" id="pre"><i class="fa fa-step-backward" aria-hidden="true"></i>
                </button>
    ...
    <div style="background-color: black;" id="sidebar-wrapper">
        <div class="sidebar-heading">
            <small class="text-muted">
                <a style="font-size: 25px; text-align: left; letter-spacing: 2px; font-family: Verdana; background: -webkit-linear-gradient(#00d0ff, #25ffbf); -webkit-background-clip: text; -webkit-text-fill-color: transparent;"
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle white_icons_text" href="#" id="navbarDropdown" role="button"
                    ...
                    <div class="card m-1 music_card"
                        ...
                        <div class="card-body music_card_body">
                            <div style="max-width: 100%;" class="img_container">
                                ...
                                <button class="play_button btn" id="menu-toggle"><i
                                        style="background: -webkit-linear-gradient(#00d0ff, #25ffbf); -webkit-background-clip: text; -webkit-text-fill-color: transparent;"
                                        class="fa fa-play"></i></button>
                            </div>
                            <h6 style="color: white;" class="pt-3">{{$song->song_name}}</h6>
                            <h7 style="color: lightgray;">Artist: <a style="color: lightgray;"
                                                                     href="/song/{{$song->album->artist->name}}">{{$song->album->artist->name}}</a>
                            </h7>
                            <br>
                            <h7 style="color: lightgray;">Album: <a style="color: lightgray;"
                                                                    href="#/song/{{$song->album->name}}">{{$song->album->name}}</a>
                            </h7>
                        </div>
                    </div>
                @endforeach
